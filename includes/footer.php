                ...
                <div class="row">
                  <div class="col-lg-7 col-sm-6">
                    <div class="widget">
                      <h5>Our Services</h5>
                      <ul>
                        <li><a href="service-single.php">Solar Panel Installation</a></li>
                        <li><a href="service-single.php">Solar Panel Maintenance</a></li>
                        <li><a href="service-single.php">Custom System Design</a></li>
                        <li><a href="service-single.php">Solar Battery Storage</a></li>
                        <li><a href="service-single.php">System Monitoring & Reporting</a></li>
                        <li><a href="service-single.php">Solar Panel Upgrades</a></li>
                      </ul>
                    </div>
                  </div>
